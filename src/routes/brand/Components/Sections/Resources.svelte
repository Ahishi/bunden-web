...
<article class="mb-8">
    ...
    <!-- Icons about -->
    <div class="my-16">
        <h4 class="text-2xl font-medium mb-2">Icons</h4>
        <p>
            Icons are the primary resources over logos. <br>
            They are meant for smaller and tight spaces and should always occupy a square of space
            as described in <a href="#clarity" class="text-blue-700 hover:underline">Clarity</a>.
        </p>
    </div>
